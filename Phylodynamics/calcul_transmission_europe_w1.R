...
mean_transmission$region %<>% factor(levels=c("United.Kingdom","Russia", "Belgium", "Germany", "Italy",  "Spain", 
                                              "France", "Netherlands", "Sweden", "Romania", "Poland"))
#stacked area chart
ggplot(mean_transmission, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=region), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#ED313C", "#16999F", "#FDD93B",
                               "#FD832F", "#558EC8",
                               "#10791E", "#57C540", "#872BBA",
                               "#867017", "#C485E6","#813008" ))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
#we order the data for the plot
mean_transmission$region %<>% factor(levels=c("Italy","United.Kingdom", "France",  "Spain", "Belgium", "Germany", 
                                              "Netherlands", "Sweden", "Russia", "Romania", "Poland"))

# stacked area chart
ggplot(mean_transmission, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=region), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#558EC8", "#ED313C", "#57C540",
                               "#10791E", "#FDD93B", "#FD832F",
                               "#872BBA", "#867017", 
                               "#16999F", "#C485E6", "#813008"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
        ...
        legend.position = "none")+
  ylim(0,60)+
  scale_x_date(date_breaks = "1 month", limits = as.Date(c('2019-10-01','2020-07-31')))+
...
#we order the data for the plot
mean_df_inter_SYM3$parent_loc %<>% factor(levels=c("Italy","United.Kingdom", "Spain",  "Belgium", "Germany",
                                                   "Russia", "Netherlands", "Sweden", "Romania", "Poland"))
#stacked area chart
ggplot(mean_df_inter_SYM3, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=parent_loc), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#558ec8", "#ed313c", "#10791e", "#fdd93b", "#fd832f",
                               "#16999f", "#5F4197", "#867017", "#c485e6", "#813008"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
#we order the data for the plot
mean_df_inter_SYM3$node_loc %<>% factor(levels=c("Belgium","Germany", "United.Kingdom",  "Spain", "Netherlands",
                                                 "Sweden", "Italy", "Russia", "Poland", "Romania"))

#stacked area chart
ggplot(mean_df_inter_SYM3, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=node_loc), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#fdd93b", "#fd832f", "#ed313c", "#10791e", "#872bba",
                               "#867017", "#558ec8", "#16999f", "#813008", "#c485e6"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
introduction = ggplot(data = introduced_france3, aes(x=type, y=freq, fill=final_clade))+
  ...
  geom_label(aes(label = final_clade),
             ...
             size = 3,
             colour = 'white')+
  scale_fill_manual(values = c("#076d2e","#f95d6a", "#ffa600",
                               "#a05195"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
...
exportation = ggplot(data = france_export3, aes(x=type, y=freq, fill=final_clade))+
  geom_bar(stat="identity")+
  scale_fill_manual(values = c("#f95d6a", "#003f5c",
                               "#a05195", "#ffa600"))+
  geom_label(aes(label = final_clade),
             position = position_stack(vjust = 0.5),
             size = 3,
