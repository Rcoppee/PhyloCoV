...
mean_transmission$region %<>% factor(levels=c( "ARA", "PACA","OCC", "BRE", "IDF"))

# stacked area chart
ggplot(mean_transmission, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=region), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#FF4D31", "#1790F5", "#e0ac15", "#6200eb", "#2EC245"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
ggplot(mean_transmission, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=region), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#e0ac15", "#1790F5", "#FF4D31", "#2EC245"))+
...
France_SYM = df_inter_SYM2[df_inter_SYM2$node_loc == "PACA",]
...
#change the identifier and scale_fill_manual the desired region
France_SYM = df_inter_SYM2[df_inter_SYM2$parent_loc == "PACA",]
...
#we order the data for the plot
mean_df_inter_SYM3$parent_loc %<>% factor(levels=c("ARA","PACA", "BRE", "OCC"))

# stacked area chart
ggplot(mean_df_inter_SYM3, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=parent_loc), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#ff4d31", "#1790f5", "#6200eb", "#e0ac15"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
#we order the data for the plot
mean_df_inter_SYM3$node_loc %<>% factor(levels=c("PACA", "IDF", "OCC", "BRE"))

# stacked area chart
ggplot(mean_df_inter_SYM3, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=node_loc), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#1790f5", "#2ec245", "#e0ac15", "#6200eb"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
#we order the data for the plot
mean_df_inter_SYM3$node_loc %<>% factor(levels=c("IDF", "ARA", "PACA", "OCC"))
...
#we order the data for the plot
mean_df_inter_SYM3$parent_loc %<>% factor(levels=c("IDF", "ARA", "OCC", "BRE"))

# stacked area chart
ggplot(mean_df_inter_SYM3, aes(x=week_2, y=total2)) + 
  geom_area(aes(fill=parent_loc), size=.5, colour="black", position="stack")+
  scale_fill_manual(values = c("#2ec245", "#ff4d31", "#e0ac15", "#6200eb"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
introduction = ggplot(data = introduced_france3, aes(x=type, y=freq, fill=final_clade))+
  ...
  geom_label(aes(label = final_clade),
             ...
             colour = 'white')+
  #IDF
  # scale_fill_manual(values = c("#f95d6a","#a05195", "#ffa600"))+
  #ARA
  # scale_fill_manual(values = c("#a05195", "#f95d6a","#ffa600"))+
  #PACA
  # scale_fill_manual(values = c("#f95d6a","#a05195","#ffa600"))+
  #OCC
  #scale_fill_manual(values = c("#003f5c", "#f95d6a","#a05195","#ffa600"))+
  #BRE
  scale_fill_manual(values = c("#655971", "#a05195","#f95d6a","#003f5c", "#ffa600"))+
  theme(axis.line.x = element_line(size = 1, colour = "black"),
        axis.line.y = element_line(size = 1, colour = "black"),
        axis.line = element_line(size=1, colour = "black"),
        panel.grid.major = element_blank(),
...
exportation = ggplot(data = france_export3, aes(x=type, y=freq, fill=final_clade))+
  geom_bar(stat="identity")+
  #IDF
  # scale_fill_manual(values = c("#076d2e","#f95d6a", "#a05195", "#ffa600"))+
  #ARA
  # scale_fill_manual(values = c("#f95d6a", "#a05195", "#ffa600"))+
  #PACA
  # scale_fill_manual(values = c("#f95d6a", "#a05195", "#ffa600"))+
  #OCC
  #scale_fill_manual(values = c("#f95d6a", "#c44563", "#7a8098", "#ffa600", "#a05195"))+
  #BRE
